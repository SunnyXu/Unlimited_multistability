...
for x in range (grid):
    ...
    for y in range (grid):
        ...
        for a in range (len(lambda_i)):
            #ri_add=Decimal(lambda_i[a])*Decimal(t)**Decimal(a+1) #overflow
            #ri_add=float(ri_add)
            ri_add=lambda_i[a]*t**(a+1)
            #log10_ri_add=np.log10(lambda_i[a])+(a+1)*np.log10(t)
            for i in range (a):
                ri_add=ri_add*lambda_i[i]
                #log10_ri_add=log10_ri_add+np.log10(lambda_i[i])
            #ri_add=10**log10_ri_add
...
## Fig2(a)
##phi_12_data_x=phi_1_data_x+phi_2_data_x
##phi_12_data_y=phi_1_data_y+phi_2_data_y            
##print(phi_12_data_x,phi_12_data_y)
##plt.plot(phi_12_data_x,phi_12_data_y,'ro')
                    
#print(phi_1_data_x,phi_1_data_y)
plt.plot(phi_1_data_x,phi_1_data_y,'g^')

##print(phi_2_data_x,phi_2_data_y)
...
#print(np.log10(E1),np.log10(F1),np.log10(E2),np.log10(F2),np.log10(E3),np.log10(F3))

#print(stable)
#print(len(stable))
#print(stable[0][0],stable[0][1],stable[1][0],stable[1][1],stable[2][0],stable[2][1])
